...
export const HeroSection = ({ onScrollToForm }: HeroSectionProps) => {
  ...
  return (
    <section className="hero-gradient min-h-screen flex flex-col items-center justify-between text-center px-4 relative overflow-hidden">
      {/* Top Content */}
      <div className="pt-8 w-full">
        ...
        {/* Headline */}
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 max-w-5xl leading-tight text-shadow fade-in-up mx-auto">
        ...
        {/* Subheading */}
        <p className="text-lg md:text-xl text-muted-foreground max-w-3xl fade-in-up mx-auto">
          Covering commercial kitchens, bakery equipment, refrigeration, ovens, 
          coffee makers, laundry solutions, and more.
        </p>
      </div>

      {/* Animated Text Line (centered) */}
      <div className="text-lg md:text-xl text-muted-foreground fade-in-up flex items-center justify-center mx-auto">
